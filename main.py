...
MONGODB_URL = os.getenv("MONGODB_URL", "mongodb+srv://ddddavvvidwarner:GwcybetDevOH6ocF@cluster0.pkn52pr.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
